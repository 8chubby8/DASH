...
- Edit mode — element drag-and-drop repositioning **(→ 1.3.7)** — long press to pick up, ghost element during drag, anchor snapping (LEFT / CENTRE / RIGHT), snap guidelines, placement animation, per-element height control
